	...
	<td>
		...
		<tr>
			<td class="reiter_d">
				...
				<%= messageBundle!=null?messageBundle.getString("ConfirmUserResPass_JSP.TabUser"):"Users"%>
				</a>
				&nbsp;
			</td>			
			...
			<td class="reiter_a">
				&nbsp;&nbsp;
				<%= messageBundle!=null?messageBundle.getString("ConfirmUserResPass_JSP.TabResUserPass"):"Reset password"%>
				&nbsp;
			</td>
			<td background="<%= baseDir%>/include/img/shade.png" width="7">
				&nbsp;
		...
		<tr>
			...
			<td class="td-back-lc" height="8"><img src="<%= baseDir%>/include/img/dummy.png" width="1" height="5">
				...
				<tr>
					...
					<%= messageBundle!=null?messageBundle.getString("ConfirmUserResPass_JSP.Form.ResPassHeadline"):"Reset password"%>
					</td>
				</tr>
				<tr>
					...
					<td width="100%" align="left" valign="top" class="td-feld-inhalt">
						...
						<tr>
							<td class="td-feld-inhalt" nowrap>
								&nbsp;
								<%= messageBundle!=null?messageBundle.getString("ConfirmUserResPass_JSP.CaptionUser"):"User"%>
								<%= uid %>: <%= messageBundle!=null?messageBundle.getString("ConfirmUserResPass_JSP.ResPassText"):"Actually reset password?"%>
							</td>
						</tr>
						</table>	
					</td>
				...
				<tr>	
					<td width="90%">&nbsp;
				   <input class="button-submit" type="button" name="button" value="<%= messageBundle!=null?messageBundle.getString("ConfirmUserResPass_JSP.Form.DoResetPass"):"Delete"%>" onClick="location.href='<%= response.encodeURL(userServletURL+"?action=resetUserPas&uid="+uid) %>&confirm=true';">
				   <input class="button-submit" type="button" name="button" value="<%= messageBundle!=null?messageBundle.getString("ConfirmUserResPass_JSP.Form.DoCancel"):"Cancel"%>" onClick="location.href='<%= response.encodeURL(userServletURL+"?action=userDetail&uid="+uid)%>';">				   
					</td>				
	</tr>
    </table>
	<!-- rahmen end -->
