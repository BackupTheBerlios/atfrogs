	...
	<td>
		...
		<tr>
			<td class="reiter_d">
				...
				<%= messageBundle!=null?messageBundle.getString("ConfirmUserDel_JSP.TabUser"):"Users"%>
				</a>
				&nbsp;
			</td>			
			...
			<td class="reiter_a">
				&nbsp;&nbsp;
				<%= messageBundle!=null?messageBundle.getString("ConfirmUserDel_JSP.TabDelUser"):"Delete user"%>
				&nbsp;
			</td>
			<td background="<%= baseDir%>/include/img/shade.png" width="7">
				&nbsp;
		...
		<tr>
			...
			<td class="td-back-lc" height="8"><img src="<%= baseDir%>/include/img/dummy.png" width="1" height="5">
				...
				<tr>
					...
					<%= messageBundle!=null?messageBundle.getString("ConfirmUserDel_JSP.Form.DelUserHeadline"):"Delete user"%>
					</td>
				</tr>
				<tr>
					...
					<td width="100%" align="left" valign="top" class="td-feld-inhalt">
						...
						<tr>
							<td class="td-feld-inhalt" nowrap>
								&nbsp;
								<%= messageBundle!=null?messageBundle.getString("ConfirmUserDel_JSP.CaptionUser"):"User"%>
								<%= uid %>: <%= messageBundle!=null?messageBundle.getString("ConfirmUserDel_JSP.DelUserText"):"Actually delete user?"%>
							</td>
						</tr>
						</table>	
					</td>
				...
				<tr>	
					<td width="90%">&nbsp;
				   <input class="button-submit" type="button" name="button" value="<%= messageBundle!=null?messageBundle.getString("ConfirmUserDel_JSP.Form.DoDelete"):"Delete"%>" onClick="location.href='<%= response.encodeURL(userServletURL+"?action=delUser&uid="+uid) %>&confirm=true';">
				   <input class="button-submit" type="button" name="button" value="<%= messageBundle!=null?messageBundle.getString("ConfirmUserDel_JSP.Form.DoCancel"):"Cancel"%>" onClick="location.href='<%= response.encodeURL(userServletURL+"?action=showUser")%>';">				   
					</td>				
	</tr>
    </table>
	<!-- rahmen end -->
