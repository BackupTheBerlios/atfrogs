	...
	<td>
		...
		<tr>
			<td class="reiter_d">
				...
				<%= messageBundle!=null?messageBundle.getString("ConfirmResGrpDel_JSP.TabResGrp"):"Resource groups"%>
				</a>
				&nbsp;
			</td>			
			...
			<td class="reiter_d">
				...
				<%= messageBundle!=null?messageBundle.getString("ConfirmResGrpDel_JSP.TabRes"):"Resources"%>
				</a>
				&nbsp;
			</td>			
			<td background="<%= baseDir%>/include/img/shade.png" width="7">
			...
			<td class="reiter_a">
				&nbsp;&nbsp;
				<%= messageBundle!=null?messageBundle.getString("ConfirmResGrpDel_JSP.TabDelRes"):"Delete resource group"%>
				&nbsp;
			</td>
			<td background="<%= baseDir%>/include/img/shade.png" width="7">
				&nbsp;
		...
		<tr>
			...
			<td class="td-back-lc" height="8"><img src="<%= baseDir%>/include/img/dummy.png" width="1" height="5">
				...
				<tr>
					...
					<%= messageBundle!=null?messageBundle.getString("ConfirmResGrpDel_JSP.Form.DelResHeadline"):"Delete resource group"%>
					</td>
				</tr>
				<tr>
					...
					<td width="100%" align="left" valign="top" class="td-feld-inhalt">
						...
						<tr>
							<td class="td-feld-inhalt" nowrap>
								&nbsp;
								<%= messageBundle!=null?messageBundle.getString("ConfirmResGrpDel_JSP.CaptionRes"):"Resource group"%>
								<%= resgroup %>: <%= messageBundle!=null?messageBundle.getString("ConfirmResGrpDel_JSP.DelResText"):"Actually delete resource group?"%>
							</td>
						</tr>
						</table>	
					</td>
				...
				<tr>	
					<td width="90%">&nbsp;
				   <input class="button-submit" type="button" name="button" value="<%= messageBundle!=null?messageBundle.getString("ConfirmResGrpDel_JSP.Form.DoDelete"):"Delete"%>" onClick="location.href='<%= response.encodeURL(resourceServletURL+"?action=delResGroup&resgroup="+resgroup) %>&confirm=true';">
				   <input class="button-submit" type="button" name="button" value="<%= messageBundle!=null?messageBundle.getString("ConfirmResGrpDel_JSP.Form.DoCancel"):"Cancel"%>" onClick="location.href='<%= response.encodeURL(resourceServletURL+"?action=resGroupDetail&resgroup="+resgroup)%>';">				   
					</td>	
	</tr>
    </table>
	<!-- rahmen end -->
