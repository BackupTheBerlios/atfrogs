	...
	<td>
		...
		<tr>
			<td class="reiter_d">
				...
				<%= messageBundle!=null?messageBundle.getString("NewRes_JSP.TabResGrp"):"Resourcegroups"%>
				</a>
				&nbsp;
			</td>			
			...
			<td class="reiter_d">
				...
				<%= messageBundle!=null?messageBundle.getString("NewRes_JSP.TabRes"):"Resources"%>
				</a>
				&nbsp;
			</td>			
			<td background="<%= baseDir%>/include/img/shade.png" width="7">
			...
			<td class="reiter_a">
				&nbsp;&nbsp;
				<%= messageBundle!=null?messageBundle.getString("NewRes_JSP.TabNew"):"New"%>
				&nbsp;
			</td>
			<td background="<%= baseDir%>/include/img/shade.png" width="7">
				&nbsp;
		...
		<tr>
			...
			<td class="td-back-lc" height="8"><img src="<%= baseDir%>/include/img/dummy.png" width="1" height="5">
				...
				<tr>
					...
					<%= messageBundle!=null?messageBundle.getString("NewRes_JSP.Form.NewText"):"Create new resource or resourcegroup"%>
					</td>
				</tr>
				<tr>
					...
					<td width="100%" align="left" valign="top" class="td-feld-inhalt">
						...
						<tr>
							<td class="td-feld-inhalt" nowrap>
								&nbsp;
								<%= messageBundle!=null?messageBundle.getString("NewRes_JSP.FormResName"):"Name"%>
							</td>
							<td class="td-feld-inhalt" width="99%">
								<input type="text" size="30" class="small_input_border" name="group_res" <%=request.getAttribute("errorMsg")!=null?"style=\"background-color:red\"":""%> tabindex="1" value="<%=request.getAttribute("group_res")==null?"":request.getAttribute("group_res")%>">
							</td>
						</tr>
						<tr>
							<td class="td-feld-inhalt">&nbsp;</td>
							<td class="td-feld-inhalt">
							<input type="radio" name="toCreate" value="res" checked="checked">
							<%= messageBundle!=null?messageBundle.getString("NewRes_JSP.FormRes"):"Resource"%>
							</td>
						</tr>
						<tr>
							<td class="td-feld-inhalt">&nbsp;</td>
							<td class="td-feld-inhalt">
							<input type="radio" name="toCreate" value="resgroup">
							<%= messageBundle!=null?messageBundle.getString("NewRes_JSP.FormResGrp"):"Resourcegroup"%>
							</td>
						</tr>
						</table>	
					</td>
      ...
      <td align="right"><INPUT TYPE="SUBMIT" CLASS="button-submit" NAME="act" VALUE="<%= messageBundle!=null?messageBundle.getString("NewRes_JSP.FormDoNew"):"New"%>"></td>
      <td align="right"><INPUT TYPE="button" CLASS="button-submit" NAME="act" VALUE="<%= messageBundle!=null?messageBundle.getString("NewRes_JSP.DoCancel"):"Cancel"%>"  onClick="location.href='<%= response.encodeURL(resourceServletURL) %>';"></td>
	</tr>
    </table>
	<!-- rahmen end -->
