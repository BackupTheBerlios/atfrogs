	...
	<td>
		...
		<tr>
			<td class="reiter_d">
				...
				<%= messageBundle!=null?messageBundle.getString("ConfirmResDel_JSP.TabResGrp"):"Resource groups"%>
				</a>
				&nbsp;
			</td>			
			...
			<td class="reiter_d">
				...
				<%= messageBundle!=null?messageBundle.getString("ConfirmResDel_JSP.TabRes"):"Resources"%>
				</a>
				&nbsp;
			</td>			
			<td background="<%= baseDir%>/include/img/shade.png" width="7">
			...
			<td class="reiter_a">
				&nbsp;&nbsp;
				<%= messageBundle!=null?messageBundle.getString("ConfirmResDel_JSP.TabDelRes"):"Delete resource"%>
				&nbsp;
			</td>
			<td background="<%= baseDir%>/include/img/shade.png" width="7">
				&nbsp;
		...
		<tr>
			...
			<td class="td-back-lc" height="8"><img src="<%= baseDir%>/include/img/dummy.png" width="1" height="5">
				...
				<tr>
					...
					<%= messageBundle!=null?messageBundle.getString("ConfirmResDel_JSP.Form.DelResHeadline"):"Delete resource"%>
					</td>
				</tr>
				<tr>
					...
					<td width="100%" align="left" valign="top" class="td-feld-inhalt">
						...
						<tr>
							<td class="td-feld-inhalt" nowrap>
								&nbsp;
								<%= messageBundle!=null?messageBundle.getString("ConfirmResDel_JSP.CaptionRes"):"Resource"%>
								<%= res %>: <%= messageBundle!=null?messageBundle.getString("ConfirmResDel_JSP.DelResText"):"Actually delete resource?"%>
							</td>
						</tr>
						</table>	
					</td>
				...
				<tr>	
					<td width="90%">&nbsp;
				   <input class="button-submit" type="button" name="button" value="<%= messageBundle!=null?messageBundle.getString("ConfirmResDel_JSP.Form.DoDelete"):"Delete"%>" onClick="location.href='<%= response.encodeURL(resourceServletURL+"?action=delRes&res="+res) %>&confirm=true';">
				   <input class="button-submit" type="button" name="button" value="<%= messageBundle!=null?messageBundle.getString("ConfirmResDel_JSP.Form.DoCancel"):"Cancel"%>" onClick="location.href='<%= response.encodeURL(resourceServletURL+"?action=allRes")%>';">				   
					</td>				
	</tr>
    </table>
	<!-- rahmen end -->
