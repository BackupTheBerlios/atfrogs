...
<%  // retrieve objects from servlet
	List resGroupIdList = (List)request.getAttribute("resGroupIdList");
%>
...
<tr>
	...
	<td>
		...
		<tr>
			<td class="reiter_a">
				&nbsp;&nbsp;
				<%= messageBundle!=null?messageBundle.getString("AllResGroups_JSP.TabResGroup"):"Resourcegroups"%>
				&nbsp;
			</td>    		
			...
			<td class="reiter_d">
				...
				<%= messageBundle!=null?messageBundle.getString("AllResGroups_JSP.TabRes"):"Resources"%>
				</a>
				&nbsp;
			</td>			
			<td background="<%= baseDir%>/include/img/shade.png" width="7">
    ...
    <tr>
        	...
        	<td>
         	...
         	<tr>
				...
				<td class="td-title-lc" align="right" nowrap="nowrap">
					...
					<%= messageBundle!=null?messageBundle.getString("AllResGroups_JSP.NewIcon"):"New resource or resourcegroup"%>
					" title="
					<%= messageBundle!=null?messageBundle.getString("AllResGroups_JSP.NewIcon"):"New resource or resourcegroup"%>
					" border="0">&nbsp;&nbsp;&nbsp;</a>
		...
		<tr>
			...
			<tr>
				...
				<%= messageBundle!=null?messageBundle.getString("AllResGroups_JSP.ResGroupName"):"Resourcegroupname"%>
				&nbsp;&nbsp;&nbsp;</td>
			</tr>

			<% // list resource groups
				if (resGroupIdList != null)
				for(int i=0; i<resGroupIdList.size(); i++){
				Object listObj = resGroupIdList.get(i);
				if(listObj == null){
					%>null<%
				}else{
			...
			<tr>
				<td class="list-table-start-ws"><a href="<%=response.encodeURL(resourceServletURL)%>?action=resGroupDetail&resgroup=<%= uid %>"><img src="<%= baseDir%>/include/img/arrow_right.png" border="0"></a></td>
				<td class="list-table-end-ws"><a href="<%=response.encodeURL(resourceServletURL)%>?action=resGroupDetail&resgroup=<%= uid %>"><%= uid %></a>&nbsp;</td>
			</tr>
