	...
	<td>
		...
		<tr>
			<td class="reiter_d">
				...
				<%= messageBundle!=null?messageBundle.getString("NewGroup_JSP.TabGrp"):"Groups"%>
				</a>
				&nbsp;
			</td>
			...
			<td class="reiter_a">
				&nbsp;&nbsp;
				<%= messageBundle!=null?messageBundle.getString("NewGroup_JSP.TabNew"):"New group"%>
				&nbsp;
			</td>
		...
		<tr>
			...
			<td class="td-back-lc" height="8"><img src="<%= baseDir%>/include/img/dummy.png" width="1" height="5">
				...
				<tr>
					...
					<%= messageBundle!=null?messageBundle.getString("NewGroup_JSP.Form.NewText"):"Create new group"%>
					</td>
				</tr>
				<tr>
					...
					<td width="100%" align="left" valign="top" class="td-feld-inhalt">
						...
						<tr>
							<td class="td-feld-inhalt" nowrap>
								&nbsp;
								<%= messageBundle!=null?messageBundle.getString("NewGroup_JSP.Form.Name"):"Name"%>
							</td>
							<td class="td-feld-inhalt" width="99%">
								<input type="text" size="30" class="small_input_border" name="group" <%=request.getAttribute("errorMsg")!=null?"style=\"background-color:red\"":""%> tabindex="1" value="<%=request.getAttribute("group")==null?"":request.getAttribute("group")%>">
							</td>
						</tr>
						</table>	
					</td>
				...
				<tr>	
					<td width="90%">&nbsp;</td>
				    <td align="right"><INPUT TYPE="SUBMIT" CLASS="button-submit" NAME="act" VALUE="<%= messageBundle!=null?messageBundle.getString("NewGroup_JSP.Form.DoNew"):"New"%>"></td>
			        <td align="right"><INPUT TYPE="button" CLASS="button-submit" NAME="act" VALUE="<%= messageBundle!=null?messageBundle.getString("NewGroup_JSP.Form.DoCancel"):"Cancel"%>" onClick="location.href='<%= response.encodeURL(groupServletURL) %>';"></td>
				</tr>
			    </table>
				<!-- rahmen end -->
