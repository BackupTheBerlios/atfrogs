...
<%  // retrieve objects from servlet
	List groupIdList = (List)request.getAttribute("groupIdList");
%>
...
<tr>
	...
	<tr>
		...
		<%= messageBundle!=null?messageBundle.getString("AllGroups_JSP.TabGrp"):"Groups"%>
		&nbsp;&nbsp;</td>
    ...
    <tr>
        	...
        	<td>
         	...
         	<tr>
				...
				<td class="td-title-lc" align="right" nowrap="nowrap">
					<a href="<%= response.encodeURL(groupServletURL+"?action=newGroup") %>"><img src="<%= baseDir%>/include/img/item_new.png" alt="
					<%= messageBundle!=null?messageBundle.getString("AllGroups_JSP.NewIcon"):"New group"%>
					" title="
					<%= messageBundle!=null?messageBundle.getString("AllGroups_JSP.NewIcon"):"New group"%>
					" border="0">&nbsp;&nbsp;&nbsp;</a>
		...
		<tr>
			...
			<tr>
				...
				<%= messageBundle!=null?messageBundle.getString("AllGroups_JSP.GrpName"):"Groupname"%>
				&nbsp;&nbsp;&nbsp;</td>
			</tr>
			...
			<% // list groups
				...
				Object listObj = groupIdList.get(i);
				if(listObj == null){
					%>null<%
				}else{
			...
			<tr>
				<td class="list-table-start-ws"><a href="<%=response.encodeURL(groupServletURL)%>?action=groupDetail&group=<%= uid %>"><img src="<%= baseDir%>/include/img/arrow_right.png" border="0"></a></td>
				<td class="list-table-end-ws"><a href="<%=response.encodeURL(groupServletURL)%>?action=groupDetail&group=<%= uid %>"><%= uid %></a>&nbsp;</td>
			</tr>
